...
Last updated: 2026-09-24. The same policy is published at https://impact.gtmhelix.com/privacy.html.
...
When an AI assistant such as Claude calls one of the tools, the server at `https://impact.gtmhelix.com/mcp` receives the tool name and the inputs for that call. It does not receive your chat history, account details, files or anything else from your conversation.
